...
class RecommendServicesByIntentAndOptions(Action):
    """
    Rasa Action for getting hybrid service recommendations by intent and db definitions using the service recommender API. 
    ...
    def name(self) -> str:
        return 'action_recommend_services_by_intent_and_options'
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: dict) -> list:
        try:
            ...
            r = requests.post(
                os.environ['RASA_ACTIONS_SERVICE_RECOMMENDER_ENDPOINT']+'/services/recommendByIntentAndOptions', json=body)
