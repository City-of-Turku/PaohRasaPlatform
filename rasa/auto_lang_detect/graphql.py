...
class GraphQLNaturalLanguageGenerator(NaturalLanguageGenerator):
    ...
    async def generate(
        ...
        **kwargs: Any,
        ...
        session_started_language = tracker.get_slot("session_started_metadata")
        session_started_language = session_started_language.get("language") if isinstance(session_started_language, dict) else None
        language = tracker.latest_message.metadata.get("language") or session_started_language or fallback_language
        ...
        # add municipality slot to be sent to the frontend via websocket
        response["municipality"] = tracker.get_slot("municipality")

        # add show_recommendations slot to be sent to the frontend via websocket
        response["show_recommendations"] = tracker.get_slot("show_recommendations")
